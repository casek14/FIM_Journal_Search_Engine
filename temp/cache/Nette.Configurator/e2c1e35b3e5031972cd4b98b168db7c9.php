<?php
// source: C:\games\XAMPP\htdocs\FIM_Journal_Search_Engine\app/config/config.neon 
// source: C:\games\XAMPP\htdocs\FIM_Journal_Search_Engine\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			'nette\\object' => array(
				...
				'23_App_model_DoajParserClanku',
				'24_App_model_DoajParserDetailuClanku',
				'25_App_model_ScopusParserClanku',
				'26_App_model_ScopusParserDetailuClanku',
				'27_App_model_SpravceClanku',
				'container',
			),
			...
			'app\\model\\iziskaniclanku' => array(
				'23_App_model_DoajParserClanku',
				'25_App_model_ScopusParserClanku',
			),
			'app\\model\\doajparserclanku' => array('23_App_model_DoajParserClanku'),
			'app\\model\\iziskanidetailuclanku' => array(
				'24_App_model_DoajParserDetailuClanku',
				'26_App_model_ScopusParserDetailuClanku',
			),
			'app\\model\\doajparserdetailuclanku' => array('24_App_model_DoajParserDetailuClanku'),
			'app\\model\\scopusparserclanku' => array('25_App_model_ScopusParserClanku'),
			'app\\model\\scopusparserdetailuclanku' => array(
				'26_App_model_ScopusParserDetailuClanku',
			),
			'app\\model\\spravceclanku' => array('27_App_model_SpravceClanku'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\\games\\XAMPP\\htdocs\\FIM_Journal_Search_Engine\\app',
			'wwwDir' => 'C:\\games\\XAMPP\\htdocs\\FIM_Journal_Search_Engine\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'C:\\games\\XAMPP\\htdocs\\FIM_Journal_Search_Engine\\app/../temp',
		));
	}


	/**
	 * @return App\model\DoajParserClanku
	 */
	public function createService__23_App_model_DoajParserClanku()
	{
		$service = new App\model\DoajParserClanku;
		return $service;
	}


	/**
	 * @return App\model\DoajParserDetailuClanku
	 */
	public function createService__24_App_model_DoajParserDetailuClanku()
	{
		$service = new App\model\DoajParserDetailuClanku;
		return $service;
	}


	/**
	 * @return App\model\ScopusParserClanku
	 */
	public function createService__25_App_model_ScopusParserClanku()
	{
		$service = new App\model\ScopusParserClanku;
		return $service;
	}


	/**
	 * @return App\model\ScopusParserDetailuClanku
	 */
	public function createService__26_App_model_ScopusParserDetailuClanku()
	{
		$service = new App\model\ScopusParserDetailuClanku;
		return $service;
	}


	/**
	 * @return App\model\SpravceClanku
	 */
	public function createService__27_App_model_SpravceClanku()
	{
		$service = new App\model\SpravceClanku;
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\\games\\XAMPP\\htdocs\\FIM_Journal_Search_Engine\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\\games\\XAMPP\\htdocs\\FIM_Journal_Search_Engine\\app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('C:\\games\\XAMPP\\htdocs\\FIM_Journal_Search_Engine\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('C:\\games\\XAMPP\\htdocs\\FIM_Journal_Search_Engine\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('C:\\games\\XAMPP\\htdocs\\FIM_Journal_Search_Engine\\app/../temp/cache', $this->getService('nette.cacheJournal'));
